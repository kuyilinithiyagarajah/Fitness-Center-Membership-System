...
<div class="container">
    <table>
        ...
        <tr>
            ...
            <td>
                <form action="delete-membership" method="POST" onsubmit="return confirm('Are you sure you want to delete this membership?')">
                    <input type="hidden" name="membership-id" value="<%= membership.getMemberShipID() %>">
